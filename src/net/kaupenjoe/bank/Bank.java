...
public class Bank {
    ...
    public boolean openBankAccount(Person person, int initialDeposit) throws BankAccountException {
    ...
    private boolean canBankAccount(Person person, int initialDeposit) throws BankAccountException {
        boolean bankOpened = true;
        if(!person.isOlderThan(16)) {
            //System.out.println(person.getFullName() + " is not old enough to open a Bank Account!");
            bankOpened = false;
            throw new BankAccountException(person.getFullName() + " is not old enough to open a Bank Account");
        }
